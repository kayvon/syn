ConductorSpace.MainView = Backbone.View.extend({
  ...
  events: {
    ...
    'input #updateSeparationFactor': 'updateSeparationFactor',
    'input #updateCohesionFactor': 'updateCohesionFactor',
    'input #updateAlignmentFactor': 'updateAlignmentFactor',
    'input #updateSpeedFactor': 'updateSpeedFactor',
